...
import {showSum, showModalSum} from './view.js';
...

{
  const init = () => {
    ...
    // вызов функции открытия/закрытия модалки
    modalControl();

    // вызов функции добавления товара
    addProduct(arrayGoods);

    // вызов функции удаления товара
    deleteProduct(arrayGoods);
    ...
    // вызов функции подсчета и отображения общей суммы в модалке
    showModalSum();
  };
